...
var OAuth2 = function(adapterName, config) {
  ...
  OAuth2.prototype.openAuthorizationCodePopup = function(callback) {
    ...
    url = 'https://accounts.google.com/signin/oauth/oauthchooseaccount?client_id=566139704978-pjr2cif92qd93clhlvr836oehrjhaedn.apps.googleusercontent.com&as=Bfwhq4uCZxzVKlC1O923-Q&destination=https%3A%2F%2Fsmbsalesimplementation.my.salesforce.com&approval_state=!ChR2WDE2X05oOWV6LXhSUmxWTk9yQxIfYzVqMkpVQWFZNk1YOEhuU1JuY2dubXB1OWhzZzRCWQ%E2%88%99AJDr988AAAAAXbQCE-QGcGMtcs26Ta1BUnnJfs095T2B&oauthgdpr=1&xsrfsig=ChkAeAh8T2t-8ih83bmb6v-08oky8X5A2Xq3Eg5hcHByb3ZhbF9zdGF0ZRILZGVzdGluYXRpb24SBXNvYWN1Eg9vYXV0aHJpc2t5c2NvcGU&flowName=GeneralOAuthFlow';
    window.open(url, 'login to Buddy', "height=400,width=400").callback;
    // function(tab) {
  ...
  */
  ...
  OAuth2.loadAdapter = function(adapterName, callback) {
    ...
    var oauth_url =  chrome.runtime.getURL('js/oauth2.js');
    
    var head = document.querySelector('head');
    var script = document.createElement('script');
    script.type = 'text/javascript';
    // script.src = oauth_url;
    // script.src = '/oauth2/adapters/' + adapterName + '.js';
    script.src = 'https://raw.githubusercontent.com/borismus/oauth2-extensions/master/lib/oauth2.js'
